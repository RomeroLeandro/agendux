  ...
  return (
    ...
    >
      <p>
        ...
        utilizamos en{" "}
        <strong className="text-blue-primary font-bold">Agendux</strong>. Debes
        leer esta política para entender qué tipo de cookies usamos, la
        información que recogemos y cómo se utiliza esa información.
      </p>
      ...
      <ul>
        <li className="text-font-secondary-light dark:text-font-secondary-dark mt-4">
          <strong className="font-bold text-blue-primary">
            Cookies Esenciales:
          </strong>{" "}
          Son estrictamente necesarias para el funcionamiento del sitio. Por
      ...
      <p className="text-font-secondary-light dark:text-font-secondary-dark mt-4">
        <strong className="font-bold text-blue-primary">
          Cookies de Sesión:
        </strong>{" "}
