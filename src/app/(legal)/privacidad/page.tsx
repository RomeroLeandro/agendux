...
export default function PrivacyPolicyPage() {
  return (
    ...
    >
      <BackButton />
      <p>
        En <strong>Agendux</strong>, respetamos tu privacidad y estamos
        comprometidos con la protección de tus datos personales. Esta política
        explica qué información recopilamos, cómo la usamos y cuáles son tus
        derechos.
      </p>
      ...
      <ul>
        ...
        <li>Imagen de perfil (si accedes con Google)</li>
        <li>
      ...
      <ul>
        ...
        <li>Garantizar el funcionamiento adecuado del sistema</li>
        <li>
      ...
      <p>
        ...
        <a href="mailto:agendux.com@gmail.com">agendux.com@gmail.com</a>.
      </p>
      ...
      <ul>
        ...
        <li>
          Sitio web:{" "}
          <Link href="/">[https://agendux.com](https://agendux.com)</Link>
        </li>
      </ul>
    </LegalPageLayout>
  );
