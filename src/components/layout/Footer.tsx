      ...
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <Typography
              variant="body-md"
              className="mt-4 max-w-xs text-font-primary-dark"
            >
          ...
          {footerLinks.map((column) => (
            <div key={column.title}>
              <Typography
                variant="heading-sm"
                as="h3"
                className="mb-4 text-font-primary-dark"
              >
                {column.title}
              </Typography>
              <nav className="mt-4">
                <ul className="space-y-3">
                  {column.links.map((link) => (
                    <li key={link.label}>
                      <Link
                        href={link.href}
                        className=" transition-colors text-gray-400 hover:text-font-primary-dark"
                      >
                        {link.label}
                      </Link>
                    </li>
        ...
        <div className="mt-12 border-t border-gray-700 pt-8 text-center md:text-left">
          <Typography variant="body-sm" className="text-font-primary-dark">
